...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ControlButton_t, stringdata) + ofs \
...
void ControlButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ControlButton *_t = static_cast<ControlButton *>(_o);
        switch (_id) {
        ...
        {
            typedef void (ControlButton::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ControlButton::clicked)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject ControlButton::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ControlButton.data,
      qt_meta_data_ControlButton,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ControlButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ControlButton.stringdata))
        return static_cast<void*>(const_cast< ControlButton*>(this));
    if (!strcmp(_clname, "QGraphicsRectItem"))
        return static_cast< QGraphicsRectItem*>(const_cast< ControlButton*>(this));
